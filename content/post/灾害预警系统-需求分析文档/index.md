...
#### 预警触发流程
![预警触发流程](行为图/预警触发流程行为图.drawio.svg)

#### 预警信息推送
![预警信息推送](行为图/预警信息推送行为图.drawio.svg)

#### 多部门协同响应
![多部门协同响应](行为图/多部门协同响应.drawio.svg)

#### 应急资源调度
![应急资源调度](行为图/应急资源调度行为图.drawio%20(1).svg)

#### 舆情监控与分析
![舆情监控与分析](行为图/舆情监控与分析行为图.drawio.svg)
